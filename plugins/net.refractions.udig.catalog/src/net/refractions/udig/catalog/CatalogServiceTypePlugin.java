...
/**
 * The plugin class for the service type.
 * @author Mifan Careem     mifanc@gmail.com
 */
public class CatalogServiceTypePlugin extends Plugin {
    public static final String ID = "net.refractions.udig.catalog.CatalogServiceTypePlugin"; //$NON-NLS-1$

    // The shared instance.
    private static CatalogServiceTypePlugin plugin;
     ...
     */
    public CatalogServiceTypePlugin() {
        super();
        plugin = this;
    }
    ...
    public void start( BundleContext context ) throws Exception {
        ...
        try {
            ...
            CatalogServiceTypePlugin.log(null, e);
    ...
    private void addSaveLocalCatalogShutdownHook() {
        ShutdownTaskList.instance().addPreShutdownTask(new PreShutdownTask(){
            ...
            public boolean handlePreShutdownException( Throwable t, boolean forced ) {
                CatalogServiceTypePlugin.log("Error storing local catalog", t); //$NON-NLS-1$
                return true;
            }
    ...
    public void restoreFromPreferences() throws BackingStoreException, MalformedURLException {
        try {
            ...
            CatalogServiceTypePlugin.log(null, new Exception(t));
        }
    }
    /**
     ...
     */
    public static CatalogServiceTypePlugin getDefault() {
        return plugin;
    }
    /**
    ...
    public static String getResourceString( String key ) {
        ResourceBundle bundle = CatalogServiceTypePlugin.getDefault().getResourceBundle();
        try {
